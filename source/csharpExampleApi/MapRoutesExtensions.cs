...
public static class MapRoutesExtensions
{
    public static void MapRoutes(this WebApplication app)
    {
        ...
        app.MapGet("/parallel", async (SuperService superService, ILogger logger) =>
        {
        ...
        app.MapGet("/throwEx", (HttpResponse response) => { throw new Exception("This is an exception thrown from the controller"); })
            .WithName("throwEx");
